...
const CSS = `@import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Instrument+Serif:ital@0;1&display=swap'); *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; } body { background: #f4f6fc; font-family: 'Plus Jakarta Sans', sans-serif; color: #111827; -webkit-font-smoothing: antialiased; } @keyframes fadeUp { from { opacity:0; transform:translateY(14px); } to { opacity:1; transform:translateY(0); } } @keyframes scaleIn { from { opacity:0; transform:scale(0.96); } to { opacity:1; transform:scale(1); } } @keyframes numberPop { 0%{transform:scale(0.8);opacity:0} 60%{transform:scale(1.06)} 100%{transform:scale(1);opacity:1} } .fade-up { animation: fadeUp 0.4s cubic-bezier(.22,.68,0,1.1) both; } .scale-in { animation: scaleIn 0.35s cubic-bezier(.22,.68,0,1.1) both; } .num-pop { animation: numberPop 0.5s cubic-bezier(.22,.68,0,1.2) both; } .card-wrap { position: relative; margin-bottom: 10px; } .card-side { transition: opacity 0.18s ease, transform 0.22s cubic-bezier(.4,0,.2,1); } .card-side.hidden { opacity:0; transform:scale(0.97); pointer-events:none; position:absolute; top:0; left:0; width:100%; } .card-side.visible { opacity:1; transform:scale(1); pointer-events:auto; position:relative; } .prof-card { transition: all 0.18s ease; cursor: pointer; } .prof-card:hover { transform: translateY(-3px); box-shadow: 0 8px 24px rgba(30,79,216,0.15); border-color: #1e4fd8 !important; } .prof-card:active { transform: scale(0.97); } .tab-btn { transition: all 0.18s; cursor: pointer; border: none; font-family: 'Plus Jakarta Sans', sans-serif; } .guide-step { animation: fadeUp 0.3s ease both; } input, button { font-family: 'Plus Jakarta Sans', sans-serif; } ::-webkit-scrollbar { width: 4px; } ::-webkit-scrollbar-thumb { background: #d1d5db; border-radius: 99px; } .stag { display:inline-block; font-size:11px; font-weight:700; padding:3px 9px; border-radius:99px; letter-spacing:0.03em; } .hover-lift { transition: transform 0.18s ease, box-shadow 0.18s ease; } .hover-lift:hover { transform: translateY(-2px); box-shadow: 0 4px 16px rgba(0,0,0,0.10); } .progress-bar { height:4px; background:#e2e5f0; border-radius:99px; overflow:hidden; } .progress-fill { height:100%; background:linear-gradient(90deg,#1e4fd8,#10b981); border-radius:99px; transition:width 0.5s ease; } input:focus { outline: 2px solid #1e4fd8; outline-offset: 1px; }`;
